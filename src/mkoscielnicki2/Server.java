...
public class Server {
	...
	public synchronized void broadcast(String msg) { // sync funktioniert so wie ein LOCK !!!!!!! lässt nur einen Thread zu einem ZP auf die Methode zugreifen. 
